...
<div class="span8 offset2">
			<h4><?php echo ($drawing_no); ?>共找到<?php echo ($mscount); ?>条结果：</h4>
			 <table class="table table-hover table-bordered">
			 	<thead>
			        <tr>
			          ...
			          <?php if(($is_newable) == "1"): ?><th>参照</th><?php endif; ?>
			        </tr>
			      </thead>
				  <tbody>
			          ...
			          <?php if(($is_newable) == "1"): ?><td>
			          		<a href="__APP__/Modify/addbytemplate?id=<?php echo ($vo["id"]); ?>">新增</a>
			          	</td><?php endif; ?>

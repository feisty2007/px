 ...
 <div class="span8 offset1">
  <form class="form-horizontal" method="post" action="__URL__/Insert">
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="EB" class="input-xlarge" name="product_no">
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="16x16x8-5stgHSB" class="input-xlarge" name="product_name">
            <p class="help-block"></p>
          </div>
          ...
          <div class="controls">
            <input type="text" placeholder="叶轮、O型圈" class="input-xlarge" name="drawing_name">
            <p class="help-block"></p>
          </div>
        </div>
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="1PEB1230****" class="input-xlarge" name="drawing_no">
            <p class="help-block"></p>
          </div>
        </div>
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="1" class="input-xlarge" name="Version">
            <p class="help-block"></p>
          </div>
        </div>   
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" placeholder="1" class="input-xlarge" name="modify_type" value="换图">
            <p class="help-block"></p>
          </div>
        </div>   

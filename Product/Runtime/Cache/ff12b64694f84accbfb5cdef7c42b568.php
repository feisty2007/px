...
<html lang="en">
 ...
 <div class="span8 offset1">  
  <form class="form-horizontal" method="post" action="__URL__/modifyone">
    <fieldset>
      <div id="legend" class="">
    ...
    <div class="control-group">
          ...
          <div class="controls">            
                <label class="checkbox">
                  <input type="checkbox" class="" <?php if(($vo["is_nuclear"]) == "1"): ?>checked<?php endif; ?> name="is_nuclear" value='1'>
                </label>              
            </div>
    </div>
    ...
    <div class="control-group">
          ...
          <div class="controls" width="400px">
                ...
                <textarea id="edcontent" name="note" style="width:300px"><?php echo ($vo["note"]); ?></textarea>
          </div>

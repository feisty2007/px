...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //,toolbars:[["bold","italic","underline","forecolor","undo","redo","insertunorderedlist","insertorderedlist","cleardoc","insertimage","attachment","date","horizontal","strikethrough","superscript","subscript","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","blockquote"]]
        ,toolbars:[["bold","italic","underline","forecolor","undo","redo","insertunorderedlist","insertorderedlist","cleardoc","attachment","date","horizontal","strikethrough","superscript","subscript","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","blockquote"]]
